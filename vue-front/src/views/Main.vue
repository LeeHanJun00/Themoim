    ...
    <div class="header">
      <div id="mainslider">
        <splide :options="options">
          <splide-slide>
            <img class="slider-image" src="../../../node-back/uploads/uploadBanner/1.png" alt="main1" />
          </splide-slide>
          <splide-slide>
            <img class="slider-image" src="../../../node-back/uploads/uploadBanner/2.png" alt="main2" />
          </splide-slide>
          <splide-slide>
            <img class="slider-image" src="../../../node-back/uploads/uploadBanner/3.png" alt="main3" />
          </splide-slide>
        </splide>
      </div>
    </div>
      ...
      <div class="left">
        ...
        <div v-if="getLoginCheck() && (recommendMoimList.length != 0)" class="recommend-moim " id="r-moim">
          ...
          <div class="left-card" v-for="(moim, index) in recommendMoimList" :key="index">
            <div class="imgbox">
              <img v-if="moim.MOIM_GRADE && (moim.MOIM_GRADE !=0)" class="badge"
                :src="require(`../assets/Badges/${setGrade(moim.MOIM_GRADE)}`)" alt=".">
              <div class="fakeimg"></div>
              <img :src="require(`../../../node-back/uploads/uploadMoim/${moim.MOIM_IMG}`)" alt="모임 이미지" class="moim-img"
            ...
            <div class="like" @click="toggleLike(moim.MOIM_NO, checkLike(moim.MOIM_NO))" v-if="user">
...
export default {
  ...
  methods: {
    ...
    async getMoimTitle(moim_no) {
      ...
      return matchingMoim ? matchingMoim.MOIM_TITLE : '모임 이름 없음';
    },
    goToDetail(moim_no) {
      axios({
