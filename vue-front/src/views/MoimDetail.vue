        ...
        <div class="box">
            ...
            <div class="left">
                ...
                <div class="home">
                    ...
                    <div class="moim-introduce">
                        <h3 class="title-introduce">✨ 모임을 소개합니다</h3><br>
                    ...
                    <div class="moim-recommend">
                        <div class="flex-container">
                            <div><img src="../assets/emoji_eyes.png"
                                    style="width: 10%; vertical-align: top; margin-right: 6px;">모임 둘러보기</div>
                        </div>
                            ...
                            <div class="left-card" v-for="(moim, index) in moimList.slice(0, 3)" :key="index">
                                <div class="imgbox">
                                    ...
                                    <img :src="require(`../../../node-back/uploads/uploadMoim/${moim.MOIM_IMG}`)"
                                        alt="모임 이미지" @click="goToDetail(moim.MOIM_NO)" class="moim-img-main">
                                </div>
            ...
            <div class="right">
                ...
                <div class="creatediv" v-if="!userJoin">
                    <button type="button" class="col-xs-1 createbtn" @click="goTo('moimjoin')">모임 가입하기</button>
                </div>
                <div class="withdraw" v-if="boss">
                    <button type="button" class="col-xs-1 createbtn" @click="goToMoimUpdate()"
                        style="width: 140px; color: #86a8e7">모임 수정하기</button>
                </div>
