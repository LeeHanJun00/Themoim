        ...
        <div class="q-wrap">
            <div id="qCon" class="fade-in-4">
                ...
                <div v-else id="rCon" class="fade-in-4">
                    ...
                    <button @click="imgSave()" class="btn">결과 이미지 저장하기</button>
                    ...
                    <div class="store-box">
                        <div class="partner">
                            <div class="text">
                                <h4 @click="getMoim(result.content.hobby)" style=" cursor: pointer;">추천 모임 보기(Click!)
                                </h4>
                            ...
                            <div v-if="moim.MOIM_IMG">
                                <div class="partnerimg">
                                    <img :src="require(`../../../node-back/uploads/uploadMoim/${moim.MOIM_IMG}`)"
                                        alt="모임 이미지" class="moim-img" @click="goToDetail(moim.MOIM_NO)">
                                </div>

                            </div>
                            <div v-else>
                                <div class="partnerimg">
                                    <img src="../assets/mbti/loading.gif" alt="모임 이미지" class="moim-img">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    methods: {
        imgSave() {
            ...
            html2canvas(document.getElementById("capture_area")).then(function (canvas) {
                ...
                el.download = '더모임 성격유형.jpg' //다운로드 할 파일명 설정
                el.click()
            }).catch((error) => {
                console.error(error);
            })
