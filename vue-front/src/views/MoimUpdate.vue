            ...
            <div class="box">
                ...
                <div class="left">
                    ...
                    <div class="moim-introduce">
                        ...
                        <textarea v-model="moimForm.moim_con" placeholder="모임 소개를 자세히 해주세요"></textarea>
                    ...
                    <hr class="AllPosts-hr">
                    <div class="moim-max">
                        <h3 class="sub-font">🥂 모임 최대 인원을 입력해주세요 <span style="font-size: 13px; color: rgb(194, 189, 189);">
                ...
                <div class="right">
                    ...
                    <div class="creatediv">
                        <button type="submit" class="col-xs-1 createbtn">모임 수정하기</button>
                    </div>
                    <div class="withdraw">
                        <button type="button" @click="deleteMoimCheck()">모임 삭제하기</button>
                    </div>
                </div>
            </div>
        </form>
