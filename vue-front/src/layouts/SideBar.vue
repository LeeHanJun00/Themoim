                        ...
                        <div style="display: flex;">
                            ...
                            <div class="notice-img">
                                <img v-if="notice.BOARD_CON && notice.USER_IMG"
                                    :src="require(`../../../node-back/uploads/uploadProfile/${notice.USER_IMG}`)" alt="모임">
                                <img v-else-if="notice.MOIM_IMG"
                                    :src="require(`../../../node-back/uploads/uploadMoim/${notice.MOIM_IMG}`)" alt="모임">
    ...
    methods: {
        ...
        setNotice(notice) {
            ...
            if (notice.NOTICE_CON == 301) {
                notice_con = `모임 <strong>${notice.MOIM_TITLE}</strong>에 새로운 가입 신청이 있습니다.`
            }
                ...
                notice_con = `<strong>${notice.MOIM_TITLE}</strong>
                모임에 <strong>${notice.USER_NICK}</strong>님이 새 게시글을 올렸어요.`
            }
