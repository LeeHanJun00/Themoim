            ...
            <div class="left">
                        ...
                        <div class="calendar" v-for="(cal, i) in calendarList" :key="i">
                            ...
                            <div class="calimg-text">
                                ...
                                <div v-for="(join, index) in calendarJoinList" :key="join.cal_no">
                                    <div v-if="cal.CAL_NO === join.cal_no">
                                        {{ join.user_nick || '이름없음' }}{{ index < join.user_nick.length - 1 ? ', ' : '' }}
                                            </div>
                                    </div>
                                </div>
                ...
                <div class="right">
                    ...
                    <div class="creatediv" v-if="!userJoin">
                        <button type="button" class="col-xs-1 createbtn">모임 가입하기</button>
                    </div>
